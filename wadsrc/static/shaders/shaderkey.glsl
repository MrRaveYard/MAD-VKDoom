#define SK1_DYNAMICLIGHT_SHADOWS	(3  << 0)
...
#define SK_GET_DYNLIGHT_SHADOWS() ((uShaderKey1 & SK1_DYNLIGHTS))
...
#define DYNLIGHT_SHADOWMAPS			(SK_GET_DYNLIGHT_SHADOWS() == SK1_DS_SHADOWMAP)
