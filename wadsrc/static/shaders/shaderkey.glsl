#define SK1_DYNLIGHT_SHADOWS		(3  << 0)
	#define SK1_DS_NONE				0
	#define SK1_DS_SHADOWMAP		1
	#define SK1_DS_RAYTRACE			2
	#define SK1_DS_RAYTRACE_PRECISE	3
...
#define SK_GET_DYNLIGHT_SHADOWS() ((uShaderKey1 & SK1_DYNLIGHT_SHADOWS))
...
#define DYNLIGHT_SHADOWMAP			(SK_GET_DYNLIGHT_SHADOWS() == SK1_DS_SHADOWMAP)
#define DYNLIGHT_RAYTRACE_FAST		(SK_GET_DYNLIGHT_SHADOWS() == SK1_DS_RAYTRACE)
#define DYNLIGHT_RAYTRACE_PRECISE	(SK_GET_DYNLIGHT_SHADOWS() == SK1_DS_RAYTRACE_PRECISE)
#define DYNLIGHT_RAYTRACE			(DYNLIGHT_RAYTRACE_FAST || DYNLIGHT_RAYTRACE_PRECISE)

// Compatibility?
#define USE_RAYTRACE_PRECISE (USE_RAYTRACE && DYNLIGHT_RAYTRACE_PRECISE)